<template>
  <v-layout column justify-center align-center class="mt-0 pt-3">
    <VueCompareImage
      class="hidden-md-and-down pt-0 mt-0"
      hover
    ...
    <vue-typer class="headline" :repeat="0" text="Hermit-ZAH"></vue-typer>
    <vue-typer
      :text="text1"
      :repeat="Infinity"
      :shuffle="false"
...
export default {
  ...
  data() {
    return {
      ...
      leftImage: "https://i.imgur.com/O2Im8zN.jpg",
      rightImage: "https://i.imgur.com/3ykAiXZ.jpg",
